...
```
if you are using the robot for remedy, use the following command
```bash
docker run -d --name="dockursim" --network="remedy" -e ROBOT_MODEL=UR5 -p 8080:8080 -p 29999:29999 -p 30001-30004:30001-30004 -v /path/to/mount/program/folder:/ursim/programs -v dockursim:/ursim --privileged --cpus=1 registry.git.unav.edu:443/daim/remedy/ursim-kafka-lml/docker_ursim:v0.1
```
